    ...
    <>
      <a
        ...
        className={`sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:rounded ${
          isDark ? 'focus:bg-slate-900 focus:text-slate-100' : 'focus:bg-white focus:text-gray-900'
        }`}
      >
        Skip to content
      </a>
      ...
      >
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 md:px-8">
          ...
          <button
            ...
            className={`rounded-full border px-3 py-1 text-xs transition focus:outline-2 focus:outline-offset-2 focus:outline-cyan-500 ${
              isDark
